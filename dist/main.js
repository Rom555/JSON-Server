...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"UserService\": () => (/* binding */ UserService)\n/* harmony export */ });\n/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helper */ \"./src/modules/helper.js\");\n\r\n\r\nclass UserService {\r\n  constructor(url) {\r\n    this._url = url;\r\n  }\r\n\r\n  getUsers() {\r\n    return (0,_helper__WEBPACK_IMPORTED_MODULE_0__.getData)(this._url);\r\n  }\r\n\r\n  addUser(user) {\r\n    return (0,_helper__WEBPACK_IMPORTED_MODULE_0__.sendData)(this._url + 1, {\r\n      method: 'POST',\r\n      body: user,\r\n    });\r\n  }\r\n\r\n  removeUser(id) {\r\n    return (0,_helper__WEBPACK_IMPORTED_MODULE_0__.sendData)(`${this._url}1/${id}`, {\r\n      method: 'DELETE',\r\n    });\r\n  }\r\n\r\n  changeUser(id, data) {\r\n    return (0,_helper__WEBPACK_IMPORTED_MODULE_0__.sendData)(`${this._url}1/${id}`, {\r\n      method: 'PATCH',\r\n      body: data,\r\n    });\r\n  }\r\n\r\n  getUser(id) {\r\n    return (0,_helper__WEBPACK_IMPORTED_MODULE_0__.getData)(`${this._url}1/${id}`);\r\n  }\r\n\r\n  editUser(id, user) {\r\n    return (0,_helper__WEBPACK_IMPORTED_MODULE_0__.sendData)(`${this._url}1/${id}`, {\r\n      method: 'PUT',\r\n      body: user,\r\n    });\r\n  }\r\n\r\n  filterUsers(filterOption) {\r\n    return (0,_helper__WEBPACK_IMPORTED_MODULE_0__.getData)(`${this._url}1?${filterOption}=true`);\r\n  }\r\n\r\n  getSortUsers(sortOption) {\r\n    return (0,_helper__WEBPACK_IMPORTED_MODULE_0__.getData)(\r\n      `${this._url}1?_sort=${sortOption.name}&_order=${sortOption.value}`\r\n    );\r\n  }\r\n\r\n  getSearchUsers(str) {\r\n    return (0,_helper__WEBPACK_IMPORTED_MODULE_0__.getData)(`${this._url}1?name_like=${str}`);\r\n  }\r\n}\r\n\n\n//# sourceURL=webpack://json-sever__lesson/./src/modules/userService.js?");
